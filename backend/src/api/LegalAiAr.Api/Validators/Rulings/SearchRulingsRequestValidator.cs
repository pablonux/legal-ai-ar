...
namespace LegalAiAr.Api.Validators.Rulings;

public sealed class SearchRulingsRequestValidator : AbstractValidator<SearchRulingsRequest>
{
    private const int MaxQueryLength = 1000;
    private const int MaxPageSize = 50;

    public SearchRulingsRequestValidator()
    {
        RuleFor(x => x)
