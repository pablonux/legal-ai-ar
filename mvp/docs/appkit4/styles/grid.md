...
In Appkit, we have resources that spare the hassle of setting up the grid and starting page designs from scratch. Check out our [Page templates](/appkit4/content/pattern-list) pattern, providing designers with ready-made layout options, complete with pre-set grids and main page components. *This pattern is available as a Figma asset.*
