...
export default function PageHeaderWithBackButtonSmall() {
  ...
  return (
    <>
      <PageHeaderWithBackButton breadcrumbList={breadcrumb} onClickEvent={clickEvent} onClickBreadCrumbItem={onClickBreadCrumbItem} disabledBack={disabled} tooltipContent="Back"></PageHeaderWithBackButton>
    </>
  )
}