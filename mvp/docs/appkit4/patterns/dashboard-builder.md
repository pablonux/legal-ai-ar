...
**Portal:** [https://appkit.pwc.com/appkit4/content/pattern_detail?name=Dashboard%20Builder&background=transparent](https://appkit.pwc.com/appkit4/content/pattern_detail?name=Dashboard%20Builder&background=transparent)
...
**Figma only.** Build with `panel`, AppKit grid, `table`/`list`; drag-drop is app-specific.
