...
**Portal:** [https://appkit.pwc.com/appkit4/content/pattern_detail?name=Page%20anchors&background=transparent](https://appkit.pwc.com/appkit4/content/pattern_detail?name=Page%20anchors&background=transparent)
...
`patterns/source/react/page-anchors/`

Extracted variant folders:
- `page-anchors-default`

## Angular implementation

Side `navigation` or anchor links; coordinate with `breadcrumb` and `header`.
