...
**Portal:** [https://appkit.pwc.com/appkit4/content/pattern_detail?name=Page%20Templates&background=transparent](https://appkit.pwc.com/appkit4/content/pattern_detail?name=Page%20Templates&background=transparent)
...
**Figma only.** Shell: `header`, `navigation` or `drawer`, `footer`, grid content area.
