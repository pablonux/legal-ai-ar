...
|-------|---------|------------------------|
| 1 — Context | [`c4-context.mermaid`](./c4-context.mermaid) | [`c4-context.puml`](./c4-context.puml) |
| 2 — Container | [`c4-container.mermaid`](./c4-container.mermaid) | [`c4-container.puml`](./c4-container.puml) |
| 3 — Component | [`c4-component.mermaid`](./c4-component.mermaid) | [`c4-component.puml`](./c4-component.puml) |

**Preview not rendering?** The full PlantUML files use `!includeurl` to fetch C4 and Azure libraries. If the VS Code PlantUML preview stays empty (network/firewall), open [`c4-container-simple.puml`](./c4-container-simple.puml) — it uses only built-in syntax and should preview reliably. For Azure icons, use the CLI with local Java + PlantUML.
...
|----------|-------------|
| [`legal-ai-ar-architecture.md`](./legal-ai-ar-architecture.md) | Technical architecture, ADRs, data model |
| [`legal-ai-ar-specs.md`](./legal-ai-ar-specs.md) | Development specifications, CQRS, API |
| [`../design/f0-1-dependencies.mermaid`](../design/f0-1-dependencies.mermaid) | .NET project dependencies |
