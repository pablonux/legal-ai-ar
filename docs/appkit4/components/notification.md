...
[notification.md](reference/notification.md) — complete usage, anatomy, examples, and “how not to use” from AppKit MCP.

## Portal

Browse components on the AppKit portal: [https://appkit.pwc.com/appkit4/content/component-list](https://appkit.pwc.com/appkit4/content/component-list) (search for **notification**).
