...
export default function PageHeaderWithBackButtonLarge() {
  ...
  return (
    <>
      <PageHeaderWithBackButton type="large" breadcrumbList={breadcrumb} onClickEvent={clickEvent} onClickBreadCrumbItem={onClickBreadCrumbItem} disabledBack={disabled} tooltipContent="Back"></PageHeaderWithBackButton>
    </>
  )
}