...
import './login-fractional.scss';
import Form from './Form';

export default function LoginFractional() {
    ...
    return (
        <LoginPattern className="fractional" type="fractional" language={language} textLanguages={textLanguages}
            renderLogin={<Form
                solid
                {...loginValue}
    ...
    // This is the sample code for dark font color for Login Fractional
    {/* <LoginPattern className="fractional dark-font-color" darkFontColorFractional={true} type="fractional" language={language} textLanguages={textLanguages}
renderLogin={<Form
    solid
    {...loginValue}
    onCancel={()=>console.log('login')}
    onOk={()=>console.log('ssologin')}
    headerLayout="vertical"
    footerLayout="vertical"
    cancelText={labels.loginText}
    okText={labels.ssoLoginText}
