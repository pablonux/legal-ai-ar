...
**Category:** Modals and Overlays

**Portal:** [https://appkit.pwc.com/appkit4/content/pattern_detail?name=Delete%20Confirmation&background=transparent](https://appkit.pwc.com/appkit4/content/pattern_detail?name=Delete%20Confirmation&background=transparent)
...
`patterns/source/react/delete-confirmation/`
...
`modal` with primary/destructive `button` actions; follow modal usage constraints.
