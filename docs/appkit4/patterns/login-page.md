...
**Portal:** [https://appkit.pwc.com/appkit4/content/pattern_detail?name=Login%20Page&background=transparent](https://appkit.pwc.com/appkit4/content/pattern_detail?name=Login%20Page&background=transparent)
...
`patterns/source/react/login-page/`
...
Centered layout: `field`, `checkbox`, `button`; use brand illustration per Figma variant.
