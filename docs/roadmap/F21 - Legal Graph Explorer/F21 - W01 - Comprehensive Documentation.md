# F21 - W01 - Documentacion Integral
...
Visualización interactiva del grafo de relaciones legales. Zoom, pan, filtros por tipo de relación, expansión de nodos.
...
```mermaid
graph TB
    subgraph "Explorador de Grafo Legal"
...
|----|--------|------|--------|
| F21-W01 | Documentacion Integral | doc | S11 |
| F21-W02 | Backend - Endpoint GET Grafo Explorar con Profundidad | backend | S11 |
| F21-W03 | Frontend - Componente Grafo Interactivo D3 o Cytoscape | frontend | S11 |
| F21-W04 | Frontend - Panel Detalle de Nodo Seleccionado | frontend | S11 |
| F21-W05 | Frontend - Filtros por Tipo de Relacion | frontend | S11 |
| F21-W06 | Testing - Tests de Explorador de Grafo | testing | S11 |
...
*F21 - Explorador de Grafo Legal — Documentación integral — Legal Ai Ar*
