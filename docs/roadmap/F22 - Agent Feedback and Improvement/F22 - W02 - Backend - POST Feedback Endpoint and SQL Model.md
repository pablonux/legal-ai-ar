# F22 - W02 - Backend - Endpoint POST Feedback y Modelo SQL
...
Implementar los endpoints de API para Feedback y Mejora de Agentes usando ASP.NET Core 10 Minimal API.
...
*F22 - W02 - Backend - Endpoint POST Feedback y Modelo SQL — Legal Ai Ar*
