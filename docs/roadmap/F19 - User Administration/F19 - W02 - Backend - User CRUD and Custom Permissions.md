# F19 - W02 - Backend - CRUD Usuarios y Permisos Custom
...
Implementar los endpoints de API para Administracion de Usuarios usando ASP.NET Core 10 Minimal API.
...
- Referir a la documentación integral (F19-W01) para modelo de datos y endpoints
...
- Depende de: F19-W01 (Documentación integral)

---

*F19 - W02 - Backend - CRUD Usuarios y Permisos Custom — Legal Ai Ar*
