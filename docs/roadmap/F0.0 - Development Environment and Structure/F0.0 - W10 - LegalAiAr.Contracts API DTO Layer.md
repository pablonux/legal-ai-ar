# F0.0 - W10 - LegalAiAr.Contracts API DTO Layer
...
This WI migrates DTOs for **waves 1–2** endpoints (auth + read catalogs) migrated in F0.0-W09; remaining
...
- **Prerequisites:** F0.0-W02 (solution structure), F0.0-W08 (architecture tests); **recommended after F0.0-W09 wave 1** (auth endpoints exist as Minimal API)
...
_F0.0 - W10 - LegalAiAr.Contracts API DTO Layer — Legal Ai Ar_
