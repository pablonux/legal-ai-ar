# F0.0 - W03 - Angular 19 Frontend Scaffolding
...
- [x] `ng lint` reports no errors on workspace libraries (`core`, `shell`, `shared-common`, `ui`); app-level a11y lint debt → **F0.0-W08**
...
- **Blocks:** FT.5-W01 (frontend CI — see FT.5 Delivery and Hosting), F1.1 (platform session setup)
- **Depends on:** F0.0-W02 (repo already created on GitHub)

---

_F0.0 - W03 - Angular 19 Frontend Scaffolding — Legal Ai Ar_
