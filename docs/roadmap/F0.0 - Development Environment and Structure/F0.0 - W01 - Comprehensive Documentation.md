# F0.0 - W01 - Comprehensive Documentation
...
Complete definition of the development environment, tech stack, monorepo structure, code conventions, branching strategy, CI/CD pipelines, Azure environment provisioning, and local development environment setup. This feature is **blocking** for all the others: no development can begin without completing F0.0.
...
docs(F0.0): add onboarding guide
...
| ID       | Name                                                           | Type     | Sprint |
| -------- | -------------------------------------------------------------- | -------- | ------ |
| F0.0-W01  | Comprehensive Documentation                                    | doc      | S00    |
| F0.0-W02  | Monorepo Setup and Backend Scaffolding                         | backend  | S00    |
| F0.0-W03  | Angular 19 Frontend Scaffolding                                | frontend | S00    |
| FT.5-W01 | GitHub Actions CI Configuration _(was F0.0-W04)_                | devops   | FT.5   |
| FT.5-W02 | Azure Infrastructure with Bicep (IaC) _(was F0.0-W05)_          | devops   | FT.5   |
| FT.5-W03 | CD Deployment Pipelines Configuration _(was F0.0-W06)_          | devops   | FT.5   |
| F0.0-W07  | Local Environment Setup and Onboarding Guide                   | doc      | S00    |
| F0.0-W08  | Code Quality Configuration (Linting, Formatting, EditorConfig) | devops   | S00    |
...
_F0.0 - Development Environment and Structure — Comprehensive Documentation — Legal Ai Ar_
