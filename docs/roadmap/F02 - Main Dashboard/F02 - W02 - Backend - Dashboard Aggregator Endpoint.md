# F02 - W02 - Backend - Endpoint Agregador Dashboard
...
Implementar los endpoints de API para Dashboard Principal usando ASP.NET Core 10 Minimal API.
...
- Referir a la documentación integral (F02-W01) para modelo de datos y endpoints
...
*F02 - W02 - Backend - Endpoint Agregador Dashboard — Legal Ai Ar*
