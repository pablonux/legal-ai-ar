# F08 - W03 - Backend - POST Chat with SignalR Streaming Endpoint
...
Implement the API endpoints for AI Agent Chat using ASP.NET Core 10 Minimal API.
...
*F08 - W03 - Backend - POST Chat with SignalR Streaming Endpoint — Legal Ai Ar*
