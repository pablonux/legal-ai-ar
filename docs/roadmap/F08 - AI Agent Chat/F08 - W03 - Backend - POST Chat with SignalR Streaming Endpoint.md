# F08 - W03 - Backend - Endpoint POST Chat con SignalR Streaming
...
Implementar los endpoints de API para Chat con Agentes IA usando ASP.NET Core 10 Minimal API.
...
*F08 - W03 - Backend - Endpoint POST Chat con SignalR Streaming — Legal Ai Ar*
