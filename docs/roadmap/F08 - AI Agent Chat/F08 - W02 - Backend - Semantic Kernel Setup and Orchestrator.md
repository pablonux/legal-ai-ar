# F08 - W02 - Backend - Semantic Kernel Setup and Orchestrator
...
Implement the Semantic Kernel plugin for AI Agent Chat. Includes native functions, semantic prompts, and connector configuration.
...
- Refer to the comprehensive documentation (F08-W01) for the data model and endpoints
...
*F08 - W02 - Backend - Semantic Kernel Setup and Orchestrator — Legal Ai Ar*
