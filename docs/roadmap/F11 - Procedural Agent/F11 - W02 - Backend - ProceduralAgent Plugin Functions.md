# F11 - W02 - Backend - Plugin AgenteProcesal Functions
...
Implementar el plugin de Semantic Kernel para Agente Procesal. Incluye native functions, prompts semánticos y configuración de connectors.
...
- Referir a la documentación integral (F11-W01) para modelo de datos y endpoints
...
- Depende de: F11-W01 (Documentación integral)

---

*F11 - W02 - Backend - Plugin AgenteProcesal Functions — Legal Ai Ar*
