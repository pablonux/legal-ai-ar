# F20 - W02 - Backend - Alert Configuration CRUD
...
Implement the API endpoints for Advanced Alert Configuration using ASP.NET Core 10 Minimal API.
...
*F20 - W02 - Backend - Alert Configuration CRUD — Legal Ai Ar*
