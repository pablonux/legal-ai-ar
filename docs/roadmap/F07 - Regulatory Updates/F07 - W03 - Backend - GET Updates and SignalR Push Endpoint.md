# F07 - W03 - Backend - GET Updates and SignalR Push Endpoint
...
Implement the API endpoints for Regulatory Updates using ASP.NET Core 10 Minimal API.
...
*F07 - W03 - Backend - GET Updates and SignalR Push Endpoint — Legal Ai Ar*
