# F07 - W03 - Backend - Endpoint GET Novedades y SignalR Push
...
Implementar los endpoints de API para Novedades Normativas usando ASP.NET Core 10 Minimal API.
...
*F07 - W03 - Backend - Endpoint GET Novedades y SignalR Push — Legal Ai Ar*
