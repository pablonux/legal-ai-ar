# F05 - W04 - Backend - Endpoint GET Norma Articulos Paginado
...
Implementar los endpoints de API para Detalle de Norma usando ASP.NET Core 10 Minimal API.
...
- Referir a la documentación integral (F05-W01) para modelo de datos y endpoints
...
*F05 - W04 - Backend - Endpoint GET Norma Articulos Paginado — Legal Ai Ar*
