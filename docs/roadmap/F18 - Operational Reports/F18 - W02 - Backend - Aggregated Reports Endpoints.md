# F18 - W02 - Backend - Endpoints de Reportes Agregados
...
Implementar los endpoints de API para Reportes Operativos usando ASP.NET Core 10 Minimal API.
...
- Referir a la documentación integral (F18-W01) para modelo de datos y endpoints
...
*F18 - W02 - Backend - Endpoints de Reportes Agregados — Legal Ai Ar*
