# FT01 - W01 - Documentacion Integral
...
Sistema de notificaciones push in-app via SignalR. Badge en navbar, toast para urgentes, centro de notificaciones.
...
```mermaid
graph TB
    subgraph "Notificaciones en Tiempo Real"
...
|----|--------|------|--------|
| FT01-W01 | Documentacion Integral | doc | S03-S04 |
| FT01-W02 | Backend - SignalR Hub NotificacionHub | backend | S03-S04 |
| FT01-W03 | Backend - Worker Storage Queue a SignalR | backend | S03-S04 |
| FT01-W04 | Frontend - NotificacionService SignalR Client | frontend | S03-S04 |
| FT01-W05 | Frontend - Badge y Toast Components | frontend | S03-S04 |
| FT01-W06 | Frontend - Centro de Notificaciones | frontend | S03-S04 |
| FT01-W07 | Testing - Tests de Notificaciones | testing | S03-S04 |
...
*FT01 - Notificaciones en Tiempo Real — Documentación integral — Legal Ai Ar*
