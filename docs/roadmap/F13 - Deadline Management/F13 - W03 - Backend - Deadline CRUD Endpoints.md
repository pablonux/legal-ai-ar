# F13 - W03 - Backend - CRUD Endpoints Plazos
...
Implementar los endpoints de API para Gestion de Plazos usando ASP.NET Core 10 Minimal API.
...
*F13 - W03 - Backend - CRUD Endpoints Plazos — Legal Ai Ar*
