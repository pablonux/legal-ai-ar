# FT02 - W01 - Comprehensive Documentation

> **Feature:** FT02 - Global Omnisearch
...
Unified search (Ctrl+K) that searches simultaneously across norms, case law, case files, and conversations.
...
| ID | Name | Type | Sprint |
|----|--------|------|--------|
| FT02-W01 | Comprehensive Documentation | doc | S04 |
| FT02-W02 | Backend - GET Global Search Multi-Index Endpoint | backend | S04 |
| FT02-W03 | Frontend - Omnisearch Modal with Keyboard Nav | frontend | S04 |
| FT02-W04 | Frontend - Results Grouped by Type | frontend | S04 |
| FT02-W05 | Testing - Omnisearch Tests | testing | S04 |
...
*FT02 - Global Omnisearch — Comprehensive Documentation — Legal Ai Ar*
